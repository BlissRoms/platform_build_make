...
# Copyright (C) 2014-2016, The BlissRoms Project
#
...
def detect_revision(repo):
    ...
    if has_branch(result, bliss_default_revision):
        print("Falling back to Bliss default revision: %s"
              % bliss_default_revision)
        return bliss_default_revision
