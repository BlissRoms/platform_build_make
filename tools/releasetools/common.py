...
class BlockDifference(object):
  ...
  def WriteScript(self, script, output_zip, progress=None,
    ...
    if not self.src:
      ...
      script.Print(" ")
      script.Print("Flashing BlissRom %s partition..." % (self.partition,))
    else:
      script.Print(" ")
      script.Print("Flashing BlissRom %s partition after verification." % (self.partition,))
  ...
  def WritePostInstallVerifyScript(self, script):
    partition = self.partition
    script.Print(" ")
    script.Print('Verifying BlissRom %s files...' % (partition,))
    ...
    if self.tgt.extended:
      ...
      script.Print(" ")
      script.Print('Verified BlissRom %s partition.' % (partition,))
      if partition == "system":
      ...
      script.Print(" ")
      script.Print('Verified BlissRom %s files.' % (partition,))
